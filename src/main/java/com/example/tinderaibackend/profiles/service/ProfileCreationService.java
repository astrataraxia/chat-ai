...
import static com.example.tinderaibackend.profiles.Utils.generateMyersBriggsTypes;
...
public class ProfileCreationService {
    ...
    private Profile generateProfileImage(Profile profile) {
        String uuid = StringUtils.isBlank(profile.id()) ? NanoIdUtils.randomNanoId() : profile.id();
        profile = new Profile(
                uuid,
                profile.firstName(),
                profile.lastName(),
